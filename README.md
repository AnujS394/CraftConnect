...
1. Artisan opens app and speaks: *“Upload new product”*
2. Takes a single photo of the product
3. AI enhances the image (background removal, clarity)
4. Artisan gives short voice description
5. AI generates:
   - Product title
